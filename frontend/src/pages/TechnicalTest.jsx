...
import { getTechnicalQuestions, submitTechnicalTest } from "../services/technicalService.js";
...
const TechnicalTest = () => {
  ...
  useEffect(() => {
    const loadQuestions = async () => {
      try {
        const response = await getTechnicalQuestions(subject, 20);
      ...
      <div className="grid gap-6 lg:grid-cols-[17rem_1fr]">
        ...
        <div className="min-w-0 space-y-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <h1 className="mt-1 text-2xl font-bold text-slate-950 dark:text-white">
                  {subjectDisplayNames[subject] || subject} - 20 Minute Practice Test
                </h1>
              </div>
            </div>
          ...
          {error ? (
            ...
            <Loader label="Loading technical questions" />
          ) : !questions.length ? (
            <div className="rounded-lg border border-slate-200 bg-white p-6 text-slate-700 shadow-soft dark:border-slate-800 dark:bg-slate-900 dark:text-slate-200">
              No technical questions are available for this subject at this time.
            </div>
          ) : (
